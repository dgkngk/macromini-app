...
import { ChefHat, X, Loader2, Clock, Flame, Plus, Bookmark, Check, MessageSquarePlus, ShoppingCart } from 'lucide-react';
  ...
  return (
    ...
    <>
      ...
      <button
        ...
        className="px-4 py-3 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-medium rounded-xl transition-all shadow-sm flex items-center justify-center gap-2"

        title={t.chef_mini_btn}

      >

        <ChefHat className="w-5 h-5" />

        <span>{t.chef_mini_btn}</span>
