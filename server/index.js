...
// 🛡️ Sentinel Security: Restrict CORS to allowed origins to prevent unauthorized access
...
if (allowedOrigins.length > 0) {
  ...
  console.warn(
    "⚠️ SECURITY WARNING: ALLOWED_ORIGINS not set. CORS is permissive (allowing all origins).",
  );
  app.use(cors());
}
