...
// 🛡️ Sentinel Security: Configure CORS
// Restrict access to allowed origins if configured.
...
if (allowedOrigins.length === 0) {
  console.warn(
    "⚠️  WARNING: ALLOWED_ORIGINS not set. CORS policy is open to all origins.",
  );
}
